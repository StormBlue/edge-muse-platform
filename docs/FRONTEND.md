...
| 路径前缀 | 文件                                                                        | 说明                                      |
| -------- | --------------------------------------------------------------------------- | ----------------------------------------- |
| 工作台   | [`views/workspace/Workspace.vue`](../web/src/views/workspace/Workspace.vue) | 生图主界面；按 provider 能力过滤模式/尺寸 |
...
| 系统管理 | [`views/sysadmin/*.vue`](../web/src/views/sysadmin/)                        | 看板、密钥、管理员、偏好、会话审计等      |
