...
| 计划                   | 路径                                                                                                                                      | 说明                                                                        |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| 案例库分页与详情懒加载 | [`prompt-cases-pagination/requirements.md`](./prompt-cases-pagination/requirements.md) · [`tasks.md`](./prompt-cases-pagination/tasks.md) | 将 1000+ 案例的一次性全量加载改为轻量列表、游标分页、服务端筛选与详情懒加载 |
