...
面向贡献者与 AI 助手的 `docs/` 入口；根目录另有 [`AGENTS.md`](../AGENTS.md)（~80 行速览）、[`CLAUDE.md`](../CLAUDE.md)（Claude Code 入口，指向 AGENTS）与 [`ARCHITECTURE.md`](../ARCHITECTURE.md)（架构详解）。
...
| [FRONTEND.md](./FRONTEND.md)       | Vue 3 结构、双入口（工作台 / AI 图像）、路由与状态 |
...
- **前端 UI 重设计**：独立 brief 已并入 [`FRONTEND.md`](./FRONTEND.md)（§ 双入口与 UI 产品线）与 [`design-docs/ai-image-generation-page.md`](./design-docs/ai-image-generation-page.md)。
