...
| AI 图像生成页面    | `/ai-image` + 工作台并存；生成入口配置与用量见 EXPERIMENTS                                  | [`ai-image-generation-page.md`](./ai-image-generation-page.md) · 任务书归档：[tasks](../archive/ai-image-generation-page-tasks.md) |
