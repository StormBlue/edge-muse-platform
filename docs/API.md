...
| Sysadmin         | `/sysadmin/providers`, `/sysadmin/provider-keys`, `/sysadmin/provider-key-groups`, `/sysadmin/generation-entry`, `/sysadmin/generation-features`, admins, dashboard, users, sessions |
