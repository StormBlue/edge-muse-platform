<!-- docs-architect-meta {"schema_version":1,"id":"SPEC-ai-image-studio","type":"product-spec","title":"Ai Image Studio product specification","status":"active","owners":[],"sources":[],"update_when":["Observable ai-image-studio behavior changes"],"relations":[],"evidence":[],"affected_docs":[],"verified_at":null,"verified_against":null} -->

# Ai Image Studio Product Specification
