...
<template>
  <form
    ...
    :class="isChatVariant ? 'chat-input-panel' : 'task-input-panel min-h-[30rem]'"
    @paste="onPaste"
  ...
  >
    ...
    <div
      class="thin-scrollbar flex min-h-0 flex-1 flex-col overflow-y-auto"
      :class="isChatVariant ? 'gap-3 p-3' : 'gap-4 p-4'"
    >
      ...
      <div v-if="isImageToImage" class="shrink-0" :class="isChatVariant ? 'order-4' : ''">
        <label
